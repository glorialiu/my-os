...
o_files := $(build_dir)/vga.o $(build_dir)/kernel_main.o $(build_dir)/memfuncs.o $(build_dir)/inline_asm.o $(build_dir)/ps2.o $(build_dir)/interrupt.o $(build_dir)/serial.o $(build_dir)/page_alloc.o $(build_dir)/page_table.o $(build_dir)/kmalloc.o $(build_dir)/process.o
h_files := $(src_dir)/vga.h $(src_dir)/memfuncs.h $(src_dir)/inline_asm.h $(src_dir)/ps2.h $(src_dir)/interrupt.h $(src_dir)/serial.h $(src_dir)/page_alloc.h $(src_dir)/page_table.h $(src_dir)/kmalloc.h $(src_dir)/process.h
